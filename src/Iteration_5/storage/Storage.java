...
public class Storage {
    ...
    public static void addFlaske(Flaske f) {
        if (f != null && !flaskeList.contains(f)) {
            flaskeList.add(f);
            saveToDisk();
        }
    }
    ...
    public static List<Flaske> getFlaskeList() {
        return Collections.unmodifiableList(flaskeList);
    }

    public static List<Regulering> getReguleringList() {
        return Collections.unmodifiableList(reguleringList);
    }
