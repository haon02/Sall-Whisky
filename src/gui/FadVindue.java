...
public class FadVindue {
    ...
    public void showAndWait() {
        ...
        leverandørComboBox.getItems().addAll(controller.getFadList().stream().map(Fad::toString).toList());
        ...
        lagerComboBox.getItems().addAll(controller.getLagerList().stream().map(Lager::getAdresse).toList());
